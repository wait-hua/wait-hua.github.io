...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toggleClass = __webpack_require__(28);
	...
	var init = function init() {
	    var rewardBtn = document.getElementByClass('page-reward-btn')[0];
	    rewardBtn.addEventListener('click', function () {
	        alert('ss');
	    });
	    // document.querySelector('.page-reward-btn').onclick = function(){
	    //     toggleClass(document.querySelector('tooltip-award')[0] ,'f-dn');
	    // }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hasClass = __webpack_require__(29);
